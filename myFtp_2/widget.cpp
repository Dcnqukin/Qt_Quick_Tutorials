    ...
    ui(new Ui::Widget)
{
    ...
    ui->cdToParentButton->adjustSize();
    ui->connectButton->adjustSize();
    ui->downloadButton->adjustSize();
    ui->progressBar->adjustSize();
    ui->passWordLineEdit->adjustSize();
    ui->fileList->adjustSize();
    ui->ftpServerLineEdit->adjustSize();
